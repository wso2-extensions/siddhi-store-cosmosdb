...
/**
 * This class represents clauses of a SELECT query as required by Siddhi CosmosDB Event Tables per supported DB vendor.
 */
public class CosmosSelectQueryTemplate {
