...
/**
 * This class contains all the Siddhi CosmosDB Event Table SQL query configuration mappings.
 */
@XmlRootElement(name = "database")
public class CosmosQueryConfigurationEntry {
    ...
    private CosmosTypeMapping cosmosTypeMapping;
    private CosmosSelectQueryTemplate cosmosSelectQueryTemplate;
    ...
    public CosmosTypeMapping getCosmosTypeMapping() {
        return cosmosTypeMapping;
    }

    public void setCosmosTypeMapping(CosmosTypeMapping cosmosTypeMapping) {
        this.cosmosTypeMapping = cosmosTypeMapping;
    }

    @XmlElement(name = "selectQueryTemplate")
    public CosmosSelectQueryTemplate getCosmosSelectQueryTemplate() {
        return cosmosSelectQueryTemplate;
    }

    public void setCosmosSelectQueryTemplate(CosmosSelectQueryTemplate cosmosSelectQueryTemplate) {
        this.cosmosSelectQueryTemplate = cosmosSelectQueryTemplate;
    }
